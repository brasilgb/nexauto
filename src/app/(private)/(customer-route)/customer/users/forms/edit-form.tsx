...
import { formSchema } from '../edit-user/[id]/schema';
import { useSession } from 'next-auth/react';

type FormData = z.infer<typeof formSchema>;
export const dynamic = 'force-dynamic';

export default function EditForm({ companies, usersys }: any) {
    ...
    const form = useForm<FormData>({
        ...
        defaultValues: {
            companyId: usersys?.companyId,
            name: usersys?.name,
            email: usersys?.email,
            password: "",
            retype_password: "",
            is_admin: usersys?.is_admin,
            status: usersys?.status,
        },
    });
    ...
    const onSubmit = async (data: FormData) => {
        ...
        setLoading(true);
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/user/${usersys?.id}`, {
            method: 'PUT',
            headers: {
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            ...
                            >
                                ...
                                <FormControl>
                                    <Select {...field} value={field.value as any} onValueChange={field.onChange}>
